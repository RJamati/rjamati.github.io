...
export const headData = {
  title: 'Rukhsar Jamati | Software Engineer based in Leicester, UK', // e.g: 'Name | Developer'
  lang: '', // e.g: en, es, fr, jp
  description:
    'Rukhsar Jamati - A Software Engineer based in Leicester, United Kingdom.', // e.g: Welcome to my website
};
...
export const heroData = {
  title: "Hello! I'm",
  name: 'Rukhsar Jamati',
  subtitle: 'A Software Engineer who enjoys Web and Mobile App Development.',
  cta: 'More about me',
};
...
export const aboutData = {
  img: 'profile.jpeg',
  paragraphOne:
    'A graduate with a Bachelors of Engineering Degree in Information Technology, based in Leicester, United Kingdom.',
  paragraphTwo:
    'Hobbies include reading, gaming, watching TV & movies but my main passion is coding.',
  paragraphThree:
...
export const projectsData = [
  {
    ...
    info:
      'An intuitive and easy to use Tip Calculator app which allows the user to calculate the tip and also split the bill between the number of people.',
    info2:
      'This Android app was created by me using Android Studio and published on the Google Play Store. See the link below.',
  ...
  },
  {
    ...
    info2:
      'Features: Custom built theme, Custom reusable sections using Advanced Custom Fields, Contact form, Mobile responsive, BootStrap',
    url: 'https://fxdfitness.com/',
    repo: '',
  },
  {
    id: nanoid(),
    ...
    info2:
      'Features: Custom reusable sections using Advanced Custom Fields, Contact form, Gallery, Mobile responsive, BootStrap',
    url: 'https://www.northperformance.co.uk/',
    repo: '',
  },
  {
    id: nanoid(),
  ...
  },
  {
    ...
    info:
      'The app allows the user to create a local account. Once logged in, the user enters their monthly income, then they will need to enter their expenses. The user can also create different categories for their expenses or income.',
    info2:
...
export const footerData = {
  networks: [
    ...
    // },
    {
      id: nanoid(),
      name: 'linkedin',
      url: 'https://www.linkedin.com/in/rukhsar-jamati',
    },
    {
      id: nanoid(),
      name: 'github',
